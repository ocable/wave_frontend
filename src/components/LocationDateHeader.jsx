  ...
  return (
    <section className="flex flex-col mx-8">
      <div className="flex flex-row justify-between">
        ...
        <nav className="text-white font-bold text-sm mt-7">
          <NavLink
            to="/"
            end
          ...
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              className="w-4 h-4 transition-transform duration-200 group-hover:-translate-x-0.5 group-hover:text-highlight"
              fill="none"
              stroke="currentColor"
              strokeWidth="2"
              strokeLinecap="round"
